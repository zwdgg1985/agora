...
public struct BlockHeader
{
    ...
    /***************************************************************************
        ...
        Note that validators & their signature are not hashed
        since they must sign off on the block header hash which
...
unittest
{
    ...
    const KP = Pair.random();  // no validation, we're just serializing
    Block block =
    {
        header:
        {
