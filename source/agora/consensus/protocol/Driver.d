...
extern(D):
    ...
    ***************************************************************************/
        ...
        ref const(Value) value, bool nomination) nothrow
    {
        ...
        try
        {
            logCall("validateValue(): Before block is deserialized");
            Block block;
    ...
    public override void emitEnvelope (ref const(SCPEnvelope) envelope)
    {
        ...
        {
            logCall("{} emitEnvelope(): Sending envelope to {}",
            ...
            {
                // todo: why does sending an envelope fail?
    ...
    ***************************************************************************/
    ...
    // todo: used by tests-cases in stellar-core, might not need it?
